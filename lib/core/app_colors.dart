...
class AppColors {
  ...
  static const Color accentGold = Color(
    0xFFC5A059,
  ); // Muted Premium Gold (High Contrast)
  static const Color lightGold = Color(0xFFD4AF37); // Classic Shiny Gold

  // --- ☀ Light Mode Palette ---
  static const Color backgroundLight = Color(
    0xFFF6F8FA,
  ); // Premium soft off-white (reduces strain)
  static const Color surfaceLight = Color(
    0xFFFFFFFF,
  ); // Clean white for cards & sheets
  static const Color textPrimaryLight = Color(
    0xFF1E2229,
  ); // Charcoal Black (Never pure black)
  static const Color textSecondaryLight = Color(
    0xFF626973,
  ); // Muted gray for subtitle/Hijri date
  static const Color borderLight = Color(0xFFE2E8F0); // Thin elegant dividers

  // ---  Dark Mode Palette  ---
  static const Color backgroundDark = Color(
    0xFF0F1115,
  ); // Deep premium midnight dark
  static const Color surfaceDark = Color(
    0xFF1A1D24,
  ); // Elevated dark container cards
  static const Color textPrimaryDark = Color(
    0xFFF1F2F6,
  ); // Soft white (reduces glare at night)
  static const Color textSecondaryDark = Color(
    0xFFA4B0BE,
  ); // Soft silver for text subtitles
